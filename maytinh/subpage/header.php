    ...
    <div id="top-header">
        <div class="container">
            <ul class="header-links pull-left">
                <li><a href="#"><i class="fa fa-phone"></i>0347089842</a></li>
                <li><a href="#"><i class="fa fa-envelope-o"></i> nabanmaytinh@gmail.com</a></li>
                <li><a href="https://diachiso.vn/ha-noi/hai-ba-trung/ta-quang-buu/23"><i class="fa fa-map-marker"></i> 23 tạ quang bửu </a></li>
            </ul>
                ...
                <div class="col-md-3">
                    <div class="header-logo">
                        <a href="index.php" class="logo">
                            <img src="./img/nashop.png" alt="logo" title="Hồng Thuận Phát">
                        </a>
                    </div>
                </div>
                <!-- /LOGO -->
